...
import tradingscope.default_config as default_config
from tradingscope.config.config_manager import config_manager
...
def get_config() -> Dict:
    ...
    # 注意：数据库配置现在由 tradingscope.config.database_manager 管理
    # 这里不再包含数据库配置，避免配置冲突
