...
class ChineseFinanceDataAggregator:
    ...
    def _get_stock_forum_sentiment(self, ticker: str, days: int) -> Dict:
        ...
        return {"sentiment_score": 0, "discussion_count": 0, "hot_topics": [], "note": "股票论坛数据获取受限，建议关注官方财经新闻", "confidence": 0}
    ...
    def _get_media_coverage_sentiment(self, ticker: str, days: int) -> Dict:
        ...
        try:
            ...
            return {"sentiment_score": avg_sentiment, "coverage_count": len(coverage_items), "confidence": min(len(coverage_items) / 5, 1.0)}
    ...
    def _calculate_overall_sentiment(self, news_sentiment: Dict, forum_sentiment: Dict, media_sentiment: Dict) -> Dict:
        ...
        return {"sentiment_score": weighted_sentiment, "confidence": total_weight / 3, "level": level}  # 平均置信度
    ...
    def _generate_sentiment_summary(self, overall_sentiment: Dict) -> str:
        ...
        level_descriptions = {"very_positive": "非常积极", "positive": "积极", "neutral": "中性", "negative": "消极", "very_negative": "非常消极"}
